...
public class StoreDemo {
    public static void main(String[] args) {
        ...
        // Задача 11
        System.out.println("\n=== Общая стоимость товаров в магазине ===");
        System.out.println(SimpleStoreTasks.calculateTotalInventoryValue(store));

        // Задача 12
        System.out.println("\n=== Корзина со стоимостью болшей чем 400 ===");
        List<Cart> carts = SimpleStoreTasks.findExpensiveCarts(store, 400);
        carts.forEach(System.out::println);

        // Задача 13
/*        System.out.println("\n=== Rоличество товаров каждой категории в магазине ===");
        Map<Category, Integer> count = SimpleStoreTasks.countProductsByCategory(store);
